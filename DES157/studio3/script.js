!function() {
    "use strict";
     ...
     const beepSound = new Audio('sounds/Sound1.mp3');
// variable for the element and then the sound
const boopBtn = document.getElementById('boop');
const boopSound = new Audio('sounds/Sound2.mp3');
    ...
    function l() {
        beepSound.play();
        t.innerHTML = `<p>${r.players[r.index]} Please roll!</p>`,
        o.innerHTML = '<button id="roll">Roll</button>',
